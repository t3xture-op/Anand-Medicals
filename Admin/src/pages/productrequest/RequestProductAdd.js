...
const RequestProductAdd = () => {
  ...
  useEffect(() => {
    ...
    async function fetchReqProduct() {
    try {
      const res = await fetch(`${API_BASE}/api/product-request/${id}`);
      ...
      console.error("Error fetching request product:", err);
    }
  }
