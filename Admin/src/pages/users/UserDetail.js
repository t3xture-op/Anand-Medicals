        ...
        <div className="md:flex">
          <div className="border-b border-gray-200 p-6 md:w-1/3 md:border-b-0 md:border-r">
            <div className="flex flex-col items-center text-center">
              ...
              <p className="text-sm text-gray-500">Customer #{user._id}</p>
          ...
          <div className="p-6 md:w-2/3">
            <div className="grid grid-cols-2 gap-4 md:grid-cols-3">
              <div className="rounded-lg bg-blue-50 p-4 text-center">
                <ShoppingBag size={20} className="mx-auto text-blue-600" />
              ...
              <div className="rounded-lg bg-green-50 p-4 text-center">
                <DollarSign size={20} className="mx-auto text-green-600" />
                <p className="mt-2 text-sm font-medium text-gray-500">Total Spent</p>
                <p className="text-2xl font-semibold text-gray-900">
                  ₹{userOrders.reduce((sum, o) => sum + o.totalAmount, 0).toLocaleString()}
                </p>
              </div>

              <div className="rounded-lg bg-purple-50 p-4 text-center">
                <Package size={20} className="mx-auto text-purple-600" />
            ...
            userOrders.map(order => (
              <div key={order._id} className="p-6">
                <div className="flex flex-col justify-between sm:flex-row sm:items-center">
                  <div>
                    <div className="flex items-center">
                      <h3 className="text-base font-medium text-gray-900">#{order._id.slice(-6)}</h3>
                  ...
                  <div className="mt-4 flex flex-col items-end sm:mt-0">
                    ...
                    <Link to={`/orders/${order._id}`} className="mt-2 inline-flex items-center text-sm font-medium text-blue-600 hover:text-blue-500">
                      View Order
                ...
                <div className="mt-4">
                  ...
                  <div className="mt-2 flex flex-wrap gap-2">
                    {order.items?.map((item, i) => (
                      <span key={i} className="inline-flex rounded-full bg-gray-100 px-2.5 py-0.5 text-xs font-medium text-gray-800">
