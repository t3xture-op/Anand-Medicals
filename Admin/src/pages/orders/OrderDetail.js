...
import { orders, prescriptions } from '../../utils/mockData';
  ...
  useEffect(() => {
    const fetchData = () => {
      ...
      if (foundOrder) {
        ...
        if (foundOrder.prescriptionId) {
          const foundPrescription = prescriptions.find(p => p.id === foundOrder.prescriptionId);
    ...
    <div className="space-y-6 fade-in">
        ...
        <div className="flex items-center space-x-2">
          ...
          <button
            ...
            className={`btn btn-primary ${
              selectedStatus === order.status || isUpdatingStatus ? 'opacity-50 cursor-not-allowed' : ''
            }`}
          >
          ...
          <div className="flex items-start">
            ...
            <div>
              ...
              <p className="mt-1 text-sm font-medium text-gray-900">
                {order.deliveryDate ? formatDate(order.deliveryDate) : 'Not delivered yet'}
              </p>
            </div>
          </div>
      ...
      <div className="grid grid-cols-1 gap-6 lg:grid-cols-3">
        ...
        <div className="space-y-6">
          ...
          {order.prescriptionRequired && prescription && (
            <div className="rounded-lg border border-gray-200 bg-white shadow-sm">
              <div className="border-b border-gray-200 px-6 py-4">
                <div className="flex items-center justify-between">
                  <h2 className="text-lg font-medium text-gray-800">Prescription</h2>
                  <Link
                ...
                <div className="mb-4 overflow-hidden rounded-lg border border-gray-200">
                  <img 
                    ...
                    onError={(e) => {
                      ...
                      e.target.src = 'https://via.placeholder.com/400x200?text=Prescription+Image';
                    }}
                  />
                </div>
